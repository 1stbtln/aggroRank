...
const playerNames = {
    ...
    "account.db93949c75f64cf3aa9af2682e53dba3": "TylerTheFox",
    "account.c30fc53eff934b3cbf125825126549e7": "jeesgalaxy",
};
...
async function fetchPlayersData(playerIds) {
    ...
    try {
        const response = await axios.get(
            `https://api.pubg.com/shards/steam/seasons/division.bro.official.pc-2018-31/gameMode/squad-fpp/players?filter[playerIds]=${idsString}`,
            {
                headers: {
...
app.get("/getPlayerStats", async (req, res) => {
    ...
    const playerId = Object.keys(playerNames).find(
        (key) => playerNames[key].toLowerCase() === playerName,
    );
    ...
    const url = `https://api.pubg.com/shards/steam/players/${playerId}/seasons/division.bro.official.pc-2018-31?filter[gamepad]=false`;
    try {
